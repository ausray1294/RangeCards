...
export function updateSensorListUI() {
    ...
    Sensor.sensors.forEach(sensor => {
        ...
        sensorElement.innerHTML = `<i class="fas fa-radar"></i> Name: ${sensor.name}, Owner: ${sensor.owner}, Type: ${sensor.type}`;
        ...
        fragment.appendChild(sensorElement);
    });
    sensorListElement.appendChild(fragment);
}
